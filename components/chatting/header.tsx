      ...
      <div className="flex items-center justify-between xl:flex-row flex-col gap-6">
        <div className="flex items-center gap-3 self-start">
          ...
          <div className="flex flex-col gap-2.5">
            <h3 className="text-lg font-medium leading-[100%]">
              الخطة المجانية
            </h3>
            <p className='text-sm pr-3 font-normal leading-[100%] text-[#00A739] relative before:content-[""] before:absolute before:w-1.5 before:h-1.5 before:bg-[#00A739] before:right-0 before:top-[50%] before:translate-y-[-50%] before:rounded-full'>
              35,000 شخص نشط
            </p>
          </div>
        </div>
